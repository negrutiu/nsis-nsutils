...
title Build: amd64-unicode&& "%NSIS%\makensis.exe" /V4 /DAMD64 "%~dp0\NSutils-Test.nsi" || pause && exit /b !errorlevel!
title Build: x86-ansi&&      "%NSIS%\makensis.exe" /V4 /DANSI  "%~dp0\NSutils-Test.nsi" || pause && exit /b !errorlevel!
title Build: x86-unicode&&   "%NSIS%\makensis.exe" /V4         "%~dp0\NSutils-Test.nsi" || pause && exit /b !errorlevel!
